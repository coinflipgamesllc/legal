...
This document was last updated on November 11th, 2015 and is subject to change at any time.
...
This privacy policy governs our information practices for the Service, which includes any websites, where a link to this policy is provided. It describes how we collect, use, share, and protect information from Players, advertisement recipients, or people browsing our sites (collectively “Users”), when Users interact with or use our Service. This includes when Users:

- Visit Coin Flip Games websites
- Play games or use applications developed by Coin Flip Games
- Play games or use applications that participate in a third party Advertisement network
...
- Passively: When our systems automatically collect information about browsers and devices and certain activity within the Service. For example, when players access games that employ Coin Flip Games Identity, our systems may automatically collect a variety of information, including device name, device fingerprint and other unique identifiers from User devices and/or User game activity.
...
- Players receive ads delivered by Third Party Advertisement Networks
...
- To analyze use of the relevant advertisement, site, game, product, or software; test changes and improvements; to personalize your experiences, and; to identify and suggest connections with other users
- To perform analytics and research aimed at improving the accuracy, effectiveness, usability, or popularity of products and services that Coin Flip Games provides
- To create and share statistics and reports from within Coin Flip Games apps
- To enable user-to-user communications
- To link to or combine with other information we have gathered
- To link user devices to account content
...
In order for Users to access and update their information, please contact us at [hi@coinflipgames.co](mailto:hi@coinflipgames.co). Access requests for players of Coin Flip Games games may require verification of the identity of the individual making the request.
...
- You can choose to use the Service in a manner that limits the data we collect. For instance, you can neglect to provide a profile image and instead opt for the default.
...
## LINKS TO SITES AND SERVICE OPERATED BY OTHERS
